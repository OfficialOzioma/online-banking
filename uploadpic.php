...
<html lang="en">
    ...
    <br />  <br />
    <div class="container">
      <form action="upload_pic_action.php" method="post" enctype="multipart/form-data" name="passport_form" onsubmit="submitForm(event);">
        <div class="card border-primary card-div">
          <img class="card-img-top" src="images/pennywise.jpg" id="displayImg" alt="image" height="250" width="100" accept="image/*">  
          <div class="card-body">
