    ...
    <div class="search-bar-wrapper">
        <div class="search-bar" id="the-search-bar">
            <div class="flex-item-search-bar" id="fi-search-bar">
                <a class="add-button" href="/online-banking/add_beneficiary.php">Add</a>
                        ...
                        <div class="flex-item-1">
                            <div class="dropdown">
                              ...
                              <div id="dropdown<?php echo $i ?>" class="dropdown-content">
                                ...
                                <a href="/online-banking/send_funds.php?cust_id=<?php echo $row1["cust_id"] ?>">Send</a>
                                <a href="/online-banking/delete_beneficiary.php?cust_id=<?php echo $row1["cust_id"] ?>"
